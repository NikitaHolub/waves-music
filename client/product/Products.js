  ...
  render() {
    ...
    return (
      ...
      {this.props.products.length > 0 ?
          ...
          {this.props.products.map((product, i) => (
            <GridListTile key={i} className={classes.tile}>
              ...
              <GridListTileBar className={classes.tileBar}
                ...
                subtitle={<span>{product.price} грн.</span>}
                actionIcon={
        ...
        </GridList></div>) : this.props.searched && (<Typography type="subheading" component="h4" className={classes.title}>Товаров не найдено! :(</Typography>)}
      </div>)
  }
}
Products.propTypes = {

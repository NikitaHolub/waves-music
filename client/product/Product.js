        ...
        <div className={classes.root}>
          <Grid container spacing={40}>
            <Grid item xs={7} sm={7}>
              <Card className={classes.card}>
                <CardHeader
                  ...
                  subheader={this.state.product.quantity > 0? 'В наличии': 'Нет в наличии'}
                  action={
                ...
                <div className={classes.flex}>
                  ...
                  <Typography component="p" type="subheading" className={classes.subheading}>
                    ...
                    <span className={classes.price}> {this.state.product.price} грн.</span>
            ...
            {this.state.suggestions.length > 0 &&
              (<Grid item xs={5} sm={5}>
                <Suggestions  products={this.state.suggestions} title='Похожие товары'/>
              </Grid>)}
          </Grid>
        </div>)
  }

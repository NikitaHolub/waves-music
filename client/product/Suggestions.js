                ...
                <div className={classes.details}>
                  <CardContent className={classes.content}>
                    ...
                    {/* <Typography component="p" className={classes.date}>
                        Добавлено на сайт {(new Date(item.created)).toDateString()}
                    </Typography> */}
                  </CardContent>
                  <div className={classes.controls}>
                    <Typography type="subheading" component="h3" className={classes.price} color="primary">{item.price} грн.</Typography>

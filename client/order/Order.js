    ...
    return (
      <Card className={classes.card}>
        ...
        <Typography type="subheading" component="h2" className={classes.subheading}>
            Код заказа: <strong>{this.state.order._id}</strong> <br/> Размещен на {(new Date(this.state.order.created)).toDateString()}
        </Typography><br/>
                      ...
                      <Card className={classes.cart} >
                        ...
                        <div className={classes.details}>
                          <CardContent className={classes.content}>
                            ...
                            <Typography type="subheading" component="h3" className={classes.itemShop} color="primary">{item.product.price} x {item.quantity} грн.</Typography>
                            ...
                            <Typography type="subheading" component="h3" color={item.status == "Cancelled" ? "error":"secondary"}>Статус: {item.status}</Typography>
                          </CardContent>
                        </div>
                      </Card>
                      <Divider/>

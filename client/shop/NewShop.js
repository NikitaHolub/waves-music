    ...
    return (<div>
      <Card className={classes.card}>
        <CardContent>
          ...
          <TextField id="name" label="Название" className={classes.textField} value={this.state.name} onChange={this.handleChange('name')} margin="normal"/><br/>
          <TextField
        ...
        <CardActions>
          ...
          <Link to='/seller/shops' className={classes.submit}><Button variant="raised">Отменить</Button></Link>
        </CardActions>
      </Card>
    </div>)
  }
